...
"Latest" means the latest **stable** release. `1.0.0-rc.5` is a candidate
...
```bash
curl -fsSL https://raw.githubusercontent.com/just-web-code/jwc-lang/main/install.sh | JWC_VERSION=v1.0.0-rc.5 bash
```

```powershell
$env:JWC_VERSION = 'v1.0.0-rc.5'
iwr -useb https://raw.githubusercontent.com/just-web-code/jwc-lang/main/install.ps1 | iex
```
